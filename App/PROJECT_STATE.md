...
Exact next task: P17-T004 - benchmark primary candidates and accept an architecture only from evidence. P17-T002 (benchmark corpus, ground truth, scoring, and mandatory multi-engine Urdu protocol) is complete. Real-engine verification, reader-side search wiring, and final acceptance evidence remain outstanding. Do not start the post-OCR cross-platform certification stages yet.
